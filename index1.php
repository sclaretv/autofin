...
<div id="cover-page"></div>
    ...
    <div id="main-content">
        ...
        <!-- contenido -->
            <section id="main" class="full-bg section">
                <?php include 'main.php'; ?>
            </section>
        
            <section  id="comencemos" class="full-bg section">
                <?php include 'comencemos.php'; ?>
            </section>        

            <!-- secciones de productos -->
            <section class=" full-bg section sections" id="portal-ces">
                <?php include 'portal-ces.php'; ?>
            </section>        
            <section class=" full-bg section sections" id="trinidad">
                <?php include 'trinidad.php'; ?>
            </section>        
            <section class=" full-bg section sections" id="panal">
                <?php include 'panal.php'; ?>
            </section>        
            <section class=" full-bg section sections" id="araña">
                <?php include 'spider.php'; ?>
            </section>        
            <section class=" full-bg section sections" id="mi-autofin">
                <?php include 'mi-autofin.php'; ?>
            </section>

            

            <section class=" full-bg section sections d-none" id="mi-autofingps">
                <?php include 'novedades/mi-autofingps.php'; ?>
            </section>

            <section class=" full-bg section sections d-none" id="buho">
                <?php include 'novedades/buho.php'; ?>
            </section>

            <section class=" full-bg section sections" id="fuerza">
                <?php include 'fuerza.php'; ?>
            </section>        

            <section class=" full-bg section" id="fuerza-fin">
