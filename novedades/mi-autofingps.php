<div class="div1">
      ...
      <div id="carousel-miautofingps" class="carousel slide carousel_productos" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item item-carousel active">
            <img src="assets/img/AUTOFIN-MIAUTOFINGPS-1.png" class="d-block mx-auto img-carousel-products" width="40%"  alt="">
          </div>
          <div class="carousel-item item-carousel ">
            <img src="assets/img/AUTOFIN-MIAUTOFINGPS-2.png" class="d-block mx-auto img-carousel-products" width="40%"  alt="">
          </div>
          <div class="carousel-item item-carousel ">
            <img src="assets/img/AUTOFIN-MIAUTOFINGPS-3.png" class="d-block mx-auto img-carousel-products" width="40%"  alt="">
          </div>
        </div>
      </div>
  ...
  <div class="div4 ">
    ...
    <div class="descripcion-productos" id="producto-mi-autofingps">
